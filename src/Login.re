      ...
      <div>
        <span>
          {switch (result) {
           ...
           | Error(_) =>
             "Invalid email/password combination. Please try again" |> Util.ste
        ...
        <form
          ...
          <div>
            ...
            <input
              ...
              placeholder="Email"
              onChange={e =>
                dispatch(Email(ReactEvent.Form.target(e)##value))
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={e =>
                dispatch(Password(ReactEvent.Form.target(e)##value))
              }
            />
          </div>
